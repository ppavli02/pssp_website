                ...
                <div class="row uniform 50%">
                    ...
                    <div class="container">
                        <form>
                            ...
                            <div class="repeatable-div-1" style="visibility: visible;">
                                <!-- Row 2 -->
                            ...
                            <div class="repeatable-div-2" style="visibility: hidden">
                                <!-- Row 2 -->
                                <div class="form-group row top-buffer">
                            ...
                            <div class="form-group row top-buffer">
                                <div class="col-md-5">
                                    <ul class="pagination">
                                        <li class="active"><a href="#" onclick="changeLayer()">1</a></li>
                                        <li><a href="#">2</a></li>
                                        <li><a href="#">3</a></li>
                                        <li><a href="#">4</a></li>
                                        <li><a href="#">5</a></li>
