							...
							<div class="row uniform 50%">
								...
								<div class="container center_input">
									<div id="div_protein" class="form-group ">
                                        ...
                                        <input type="text" class="form-control" aria-describedby="protein_ErrorStatus" name="protein" id="protein" value="" placeholder="protein"  />
                                        <span class="glyphicon glyphicon-remove form-control-feedback" style="display: none" id="protein_xMark" aria-hidden="true"></span>
									...
									<div class="form-group">
										<div class="select-wrapper">
											<select name="category" id="category">
                                                <?php $i=0;while($i<count($ResultModel)){?>
							...
							<div class="row uniform 50%">
								...
								<div class="container center_input">
										<div id="div_placeCode" class="form-group">
											<label class="control-label" style="display: none" id="placeCode_required" for="getResults">Required</label>
											<input type="text" name="getResults" aria-describedby="placeCode_ErrorStatus"  id="getResults" value="" placeholder="code" />
											<span class="glyphicon glyphicon-remove form-control-feedback" style="display: none" id="placeCode_xMark" aria-hidden="true"></span>
...
<!--                        </div>-->
                        <label class="control-label" style="display: none;width:100%" id="choose">* You must choose email or generate code</label>
