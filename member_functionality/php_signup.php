<?php
    ...
    try {
        $sql = "INSERT INTO `USER` (`firstname`, `lastname`, `email`, `password`, `timesVisited`, `accountType`)
        VALUES ('$firstname', '$lastname', '$user_username', '$user_password', '$timesVisited', '$accountType')";
        $conn->exec($sql);
